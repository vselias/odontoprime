...
public class RegistroVendaMB implements Serializable {
	...
	public void setConsultasPorPacienteFiltrado(
			List<Consulta> consultasPorPacienteFiltrado) {
	...
	public void calcularVendaPorData() {
		valorTotal = registroVendaService.valorTotalVendaPorData(dataInicio,
				dataFinal);
		buscarConsultasPorData();
	}
	...
	public void buscarConsultasPorData() {
		...
		consultasPorData = registroVendaService.buscarConsultasPorData(
	...
	public void limpar() {
		...
		MensagemUtil.enviarMensagem("Campos limpos.",
